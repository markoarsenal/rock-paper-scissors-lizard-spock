        ...
        return (
          <div
            ...
            className={clsx(
              ...
              'w-1/4 absolute transform -translate-x-1/2 -translate-y-1/2 rounded-full animate__animated animate__pulse animate__infinite animate__delay-1s',
            )}
            style={{
              left: `${x}%`,
              top: `${y}%`,
          ...
          >
            <div
              className={clsx(
                styles.choice,
                'p-2 border-4 border-white aspect-square rounded-full bg-main shadow-default hover:scale-110 transition-transform duration-200 transition-ease cursor-pointer animate__animated animate__zoomInDown',
              )}
            >
